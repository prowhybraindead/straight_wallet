                ...
                >
                    ...
                    >
                        ...
                        <div className="flex justify-between items-start relative z-10 mb-2">
                            ...
                            <CardIssuerLogo issuer={card.scheme} className="h-10 sm:h-12 w-auto object-contain drop-shadow-md" theme={theme} />
                    ...
                    >
                        ...
                        <div className="px-6 relative flex-1 flex flex-col justify-center">
                            ...
                            <div className="flex justify-between items-start mb-8">
                                ...
                                <CardIssuerLogo issuer={card.scheme} className="h-10 sm:h-12 w-auto object-contain drop-shadow-md" theme="light" />
